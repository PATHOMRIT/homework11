...
import 'package:homework11/foods_model.dart';
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text("${food.getName(index)}", style: TextStyle(fontSize: 30.0,),),
                        Text("${food.getPrice(index)} บาท", style: TextStyle(fontSize: 20.0),),
                      ],
                    ),
                  ],
                ),
